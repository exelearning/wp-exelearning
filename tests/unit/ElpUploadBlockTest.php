...
class ElpUploadBlockTest extends WP_UnitTestCase {
	...
	/**
	 * By default the block offers the teacher layer selector through the
	 * package's ?exe-teacher=1 URL parameter, without injecting any CSS/JS.
	 */
	public function test_block_offers_teacher_selector_by_default() {
		$attachment_id = $this->factory->attachment->create();
